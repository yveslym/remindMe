...
//                                     enableInsets: true)
    ...
    func setupTypeButton(){
        ...
        typeLabel = CustomLabel(fontSize: 14, text: "Reminder Type: ", textColor: #colorLiteral(red: 0.3333333433, green: 0.3333333433, blue: 0.3333333433, alpha: 1))
...
//        descriptionStack.anchor(top: stack?.bottomAnchor,
//                                            left: mainView.leftAnchor,
//                                            bottom: nil,
//                                            right: mainView.rightAnchor,
//                                            paddingTop: 5,
...
//        mainStack.centerXAnchor.constraintEqualToSystemSpacingAfter(mainView.centerXAnchor, multiplier: 1).isActive = true
        ...
        saveButton.heightAnchor.constraint(equalTo: mainStack.heightAnchor, multiplier: 0.05).isActive = true
